...
* **Первый выход без мучений.** Кнопка хода показывает набранную сумму
  ...
  выход вообще. С включённым автодобором сразу после раздачи все игроки
  по кругу добирают по одной фишке, пока выход на 30 не появится у
  каждого, — руки остаются одинакового размера, и партия начинается для
  всех одновременно.
