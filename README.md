...
* **Первый выход без мучений.** Кнопка хода показывает набранную сумму
  ...
  выход вообще. Автопропуск (включается при старте) сам берёт фишку и
  передаёт ход, пока у игрока нет ни одного варианта выйти, — устройство
  не гуляет по кругу впустую.
